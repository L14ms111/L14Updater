...
| InstallUpdate(string location)                                                                  	| Start an executable (.exe, .msi) or extract a zip archive to install the update.(not for Xamarin Android)                                                                                                                                                                                       	|
...
Android : Xamarin Android (no for installUpdate();)
